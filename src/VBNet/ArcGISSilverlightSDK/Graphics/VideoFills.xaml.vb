...
Partial Public Class VideoFills
    ...
    Private Sub MyGraphicsLayer_MouseEnter(ByVal sender As Object, ByVal args As GraphicMouseEventArgs)
        ...
        Dim stateMediaElement As New MediaElement() With {.Source = New Uri(String.Format("http://serverapps102.esri.com/media/{0}_small.wmv", stateName), UriKind.Absolute), .Stretch = Stretch.None, .AutoPlay = True, .IsMuted = True, .Opacity = 0.0, .IsHitTestVisible = False}
